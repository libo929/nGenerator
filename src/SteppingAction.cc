...
void SteppingAction::UserSteppingAction(const G4Step* aStep)
{
  ...
  {
      const G4StepPoint* startingPoint = aStep->GetPreStepPoint();
	  double totalEnergy0 = startingPoint->GetTotalEnergy();
	  double totalEnergy1 = endPoint->GetTotalEnergy();
	  G4cout << "gamma process: " << process->GetProcessName() << ", e0: " << totalEnergy0 << ", e1: " << totalEnergy1 << G4endl;
  }
#endif
